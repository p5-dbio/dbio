...
use DBIO::ClassResolver::PassThrough;
use DBI;
use Scalar::Util 'blessed';
use namespace::clean;

unless ($INC{"DBIO/CDBICompat.pm"}) {
  warn "IMPORTANT: DBIO::DB is DEPRECATED AND *WILL* BE REMOVED. DO NOT USE.\n";
}
...
DBIO::DB - (DEPRECATED) classdata schema component

=head1 DESCRIPTION

This class is designed to support the Class::DBI connection-as-classdata style
for DBIO. You are *strongly* recommended to use a DBIO::Schema
instead; DBIO::DB will not undergo new development and will be moved
...
Sets or gets the storage backend. Defaults to L<DBIO::Storage::DBI>.
...
L<DBIO::ClassResolver::Passthrough>, which returns whatever you give
...
Creates a class method ->schema_instance which contains a DBIO::Schema;
all class-method operations are proxies through to this object. If you don't
call ->connection in your DBIO::DB subclass at load time you *must*
...
is rethrown. See L<DBIO::Schema/"txn_do"> for more details.
...
native L<DBIO::ResultSet> system.
...
# (with good reason) DBIO::Schema copies the result source for
