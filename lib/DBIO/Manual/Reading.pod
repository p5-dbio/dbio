# PODNAME: DBIO::Manual::Reading
# ABSTRACT: Conventions for reading and writing DBIO POD

=head1 DESCRIPTION

This document explains how DBIO documentation is structured and how its examples
and method signatures should be read. It is also the style guide for people
adding or updating POD in the DBIO ecosystem.
...
For example, L<DBIO::Relationship> documents the methods
actually coded in the helper relationship classes like
DBIO::Relationship::BelongsTo. The BelongsTo file itself is
hidden from PAUSE as it has no documentation. The accessors created by
relationships should be mentioned in L<DBIO::Row>, the major
...
%var - A hashref variable (list of key/value pairs) - rarely used in DBIO.
...
L<$obj|DBIO> - Reference to the source class or object definition
...
documentation.  For example:
  ...
  ## Correct, if stated within DBIO::ResultSet
  L<$resultset|/new>

  ## Correct, if stated outside DBIO::ResultSet
  L<$resultset|DBIO::ResultSet>
