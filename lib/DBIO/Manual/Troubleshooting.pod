# PODNAME: DBIO::Manual::Troubleshooting
# ABSTRACT: Troubleshooting common DBIO problems
...
The C<DBIO_TRACE> environment variable controls
...
Alternatively you can do this with the environment variable, too:-
  ...
  export DBIO_TRACE="1=/tmp/trace.out"
...
columns to fail with a message such as:
  ...
  Can't get last insert id at /.../DBIO/Row.pm line 95
...
L<DBIO::Manual::Cookbook/Setting quoting for the generated SQL> for
details.
...
There is a problem with slow performance of certain DBIO
...
degradation exponential to the number of L<DBIO> result objects in
...
of the bless/overload problem can be found in the L<DBIO> test
...
It has been observed, using L<DBD::ODBC>, that creating a L<DBIO::Row>
