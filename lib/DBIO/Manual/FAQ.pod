...
DBIO::Manual::FAQ - Frequently Asked Questions (in theory)
...
Behind the scenes, DBIO uses L<SQL::Abstract::Classic> to help construct
its SQL searches. So if you fail to find help in the
L<DBIO::Manual::Cookbook>, try looking in the L<SQL::Abstract::Classic>
documentation.
