...
DBIO::Manual::Cookbook - Miscellaneous recipes
...
explained in L<DBIO::ResultSet/DBIC BIND VALUES>.

See also L<SQL::Abstract::Classic/Literal SQL with placeholders and bind values
(subqueries)>.
