...
See also: L<DBIO::DeploymentHandler>

=head2 Schema::Loader

Create a DBIO schema from your database.
 ...
 use base 'DBIO::Schema::Loader';

 __PACKAGE__->loader_options({
    naming => 'v7',
    debug  => $ENV{DBIO_TRACE},
 });
...
See L<DBIO::Schema::Loader> and L<DBIO::Schema::Loader::Base/CONSTRUCTOR OPTIONS>.
...
=item See L<DBIO::Schema::KiokuDB>
