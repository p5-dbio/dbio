...
DBIO needs to know what your Table structure looks like.  You
do that by defining Result classes. Result classes are defined by
calling methods proxied to L<DBIO::ResultSource>.  Each Result
...
DBIO doesn't limit you to creating only simple ResultSets -- if you
...
DBIO tends to wait until it absolutely must fetch information from the
...
DBIO::Schema::Loader>, which shows you how to use
L<DBIO::Schema::Loader>.
