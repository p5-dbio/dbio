...
DBIO::Manual::ResultClass - Representing a single result (row) from
a DB query
...
In L<DBIO>, a user normally receives query results as instances of a
...
of your L<DBIO::Schema> instance.
