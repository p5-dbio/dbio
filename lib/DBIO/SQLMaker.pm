...
DBIO::SQLMaker - An SQL::Abstract::Classic-like SQL maker class

=head1 DESCRIPTION

This module serves as a mere "nexus class" providing
L<SQL::Abstract::Classic>-like functionality to L<DBIO> itself, and
...
L<SQLMaker rebase|DBIO::Storage::DBI/connect_call_rebase_sqlmaker>
...
|https://github.com/Perl5/DBIO/blob/master/lib/DBIO/Storage/DBIHacks.pm>
...
functionality|https://github.com/Perl5/DBIO/blob/7ef1a09ec4/lib/DBIO/Storage/DBIHacks.pm#L373-L396>
