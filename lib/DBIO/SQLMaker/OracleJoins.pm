...
Overrides DBIO::SQLMaker's select() method, which calls _oracle_joins()
...
=item L<DBIO::Storage::DBI::Oracle::WhereJoins> - Storage class using this

=item L<DBIO::SQLMaker> - Parent module
