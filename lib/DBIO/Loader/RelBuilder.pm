package DBIO::Loader::RelBuilder;
# ABSTRACT: Relationship inference engine
...
use DBIO::Loader::Utils qw/split_name slurp_file array_eq apply uniq/;
use Try::Tiny;
...
DBIO::Loader::RelBuilder - Builds relationships for DBIO::Loader
...
This class builds relationships for L<DBIO::Loader>.  This
...
sub new {
    ...
    # are better documented in L<DBIO::Loader::Base>.
...
See "RELATIONSHIP NAME COLLISIONS" in perldoc DBIO::Loader::Base .
EOF
