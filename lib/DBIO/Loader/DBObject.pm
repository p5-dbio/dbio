package DBIO::Loader::DBObject;
# ABSTRACT: Base class for database metadata objects
...
DBIO::Loader::DBObject - Base Class for Database Objects Such as
Tables and Views in L<DBIO::Loader>
...
L<qualify_objects|DBIO::Loader::Base/qualify_objects> testing on
SQLite.)
...
Returns a value suitable for the C<< __PACKAGE__->table >> call in L<DBIO> Result files.
...
the L<moniker_parts|DBIO::Loader::Base/moniker_parts> of
...
L<DBIO::Loader::Table>, L<DBIO::Loader>,
L<DBIO::Loader::Base>
