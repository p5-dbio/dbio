package DBIO::Loader::RelBuilder::Compat::v0_05;
# ABSTRACT: RelBuilder compatibility for v0.05

use strict;
use warnings;
use base 'DBIO::Loader::RelBuilder::Compat::v0_06';
use mro 'c3';
use DBIO::Loader::Utils 'array_eq';
use namespace::clean;
...
DBIO::Loader::RelBuilder::Compat::v0_05 - RelBuilder for
compatibility with DBIO::Loader version 0.05003
