...
__PACKAGE__->sql_maker_class('DBIO::SQLMaker::MSSQL');
...
sub _select_args_to_query {
  ...
  if (
    ...
    $self->throw_exception(
      'An ordered subselect encountered - this is not safe! Please see "Ordered Subselects" in DBIO::Storage::DBI::MSSQL'
...
L<DBIO::Storage::DBI::ODBC::Microsoft_SQL_Server> and
L<DBIO::Storage::DBI::Sybase::Microsoft_SQL_Server>.
...
L<has_many|DBIO::Relationship/has_many> relationship with limit/group
...
L<resultset attribute|DBIO::ResultSet/ATTRIBUTES> C<unsafe_subselect_ok>.
