package DBIO::Storage::DBI::InterBase;

use strict;
use warnings;
use base qw/DBIO::Storage::DBI::Firebird::Common/;
use mro 'c3';
use Try::Tiny;
use namespace::clean;
...
DBIO::Storage::DBI::InterBase - Driver for the Firebird RDBMS via
L<DBD::InterBase>

=head1 DESCRIPTION

This driver is a subclass of L<DBIO::Storage::DBI::Firebird::Common> for
