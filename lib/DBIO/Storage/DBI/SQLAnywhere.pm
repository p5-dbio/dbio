package DBIO::Storage::DBI::SQLAnywhere;

use strict;
use warnings;
use base qw/DBIO::Storage::DBI::UniqueIdentifier/;
use mro 'c3';
use Try::Tiny;
use namespace::clean;
...
__PACKAGE__->cursor_class('DBIO::Storage::DBI::SQLAnywhere::Cursor');

=head1 NAME

DBIO::Storage::DBI::SQLAnywhere - Driver for SQL Anywhere

=head1 DESCRIPTION

This class implements autoincrements for SQL Anywhere and provides
L<DBIO::InflateColumn::DateTime> support and support for the
C<uniqueidentifier> type (via
L<DBIO::Storage::DBI::SQLAnywhere::Cursor>.)
...
Recommended L<connect_info|DBIO::Storage::DBI/connect_info> settings:
...
sub select_single {
  ...
  return @row
    unless $self->cursor_class->isa('DBIO::Storage::DBI::SQLAnywhere::Cursor');
...
A L<DBIO> application can use a lot of cursors, due to the usage of
