package DBIO::Storage::DBI::ACCESS;

use strict;
use warnings;
use base 'DBIO::Storage::DBI::UniqueIdentifier';
use mro 'c3';

use DBI ();

__PACKAGE__->sql_limit_dialect ('Top');
__PACKAGE__->sql_maker_class('DBIO::SQLMaker::ACCESS');
...
DBIO::Storage::DBI::ACCESS - Support specific to MS Access

=head1 DESCRIPTION

This is the base class for Microsoft Access support.

This driver supports L<last_insert_id|DBIO::Storage::DBI/last_insert_id>,
empty inserts for tables with C<AUTOINCREMENT> columns, nested transactions via
L<auto_savepoint|DBIO::Storage::DBI/auto_savepoint>, C<GUID> columns via
L<DBIO::Storage::DBI::UniqueIdentifier>.
...
L<auto_nextval|DBIO::ResultSource/auto_nextval> you will need to set a
L<new_guid|DBIO::Storage::DBI::UniqueIdentifier/new_guid> callback, like
so:
