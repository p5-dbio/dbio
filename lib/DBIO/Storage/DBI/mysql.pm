...
__PACKAGE__->sql_maker_class('DBIO::SQLMaker::MySQL');
...
This class implements MySQL specific bits of L<DBIO::Storage::DBI>,
...
L<relationship attributes|DBIO::Relationship::Base/join_type>
