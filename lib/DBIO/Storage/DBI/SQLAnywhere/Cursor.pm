package DBIO::Storage::DBI::SQLAnywhere::Cursor;
...
DBIO::Storage::DBI::SQLAnywhere::Cursor - GUID Support for SQL Anywhere
...
L<DBIO::Storage::DBI::SQLAnywhere> for information on the SQL Anywhere
driver.
...
L<DBIO::Storage::DBI::SQLAnywhere> sets
