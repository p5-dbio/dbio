...
__PACKAGE__->sql_maker_class('DBIO::SQLMaker::Oracle');
...
L<DBIO::Storage::DBI::Oracle::WhereJoins> is for C<(+)> joins in Oracle
versions before 9.0.
...
In L<connect_info|DBIO::Storage::DBI/connect_info> to set the session nls
date, and timestamp values for use with L<DBIO::InflateColumn::DateTime>
...
To get more than second precision with L<DBIO::InflateColumn::DateTime>
...
### https://github.com/Perl5/DBIO/commit/5db2758de6
#
