package DBIO::Storage::DBI::ADO::Microsoft_SQL_Server::Cursor;

use strict;
use warnings;
use base 'DBIO::Storage::DBI::Cursor';
use mro 'c3';
use DBIO::Storage::DBI::ADO::CursorUtils qw/_normalize_guids _strip_trailing_binary_nulls/;
use namespace::clean;

=head1 NAME

DBIO::Storage::DBI::ADO::Microsoft_SQL_Server::Cursor - Remove trailing
...
L<DBIO::Storage::DBI::ADO::Microsoft_SQL_Server> for information on the
Microsoft SQL Server driver for ADO and L<DBIO::Storage::DBI::MSSQL> for
...
L<DBIO::Storage::DBI::ADO::Microsoft_SQL_Server> sets
L<cursor_class|DBIO::Storage::DBI/cursor_class> to this class by
default. It is overridable via your
L<connect_info|DBIO::Storage::DBI/connect_info>.

You can use L<DBIO::Cursor::Cached> safely with this class and not lose
the binary data normalizing functionality,
L<::Cursor::Cached|DBIO::Cursor::Cached> uses the underlying class data
