package DBIO::Storage::DBI::ADO::MS_Jet;

use strict;
use warnings;
use base qw/
  DBIO::Storage::DBI::ADO
  DBIO::Storage::DBI::ACCESS
/;
use mro 'c3';
use DBIO::Storage::DBI::ADO::CursorUtils '_normalize_guids';
use namespace::clean;

__PACKAGE__->cursor_class('DBIO::Storage::DBI::ADO::MS_Jet::Cursor');

=head1 NAME

DBIO::Storage::DBI::ADO::MS_Jet - Support for MS Access over ADO

=head1 DESCRIPTION

This driver is a subclass of L<DBIO::Storage::DBI::ADO> and
L<DBIO::Storage::DBI::ACCESS> for connecting to MS Access via
L<DBD::ADO>.

See the documentation for L<DBIO::Storage::DBI::ACCESS> for
information on the MS Access driver for L<DBIO>.

This driver implements workarounds for C<TEXT/IMAGE/MEMO> columns, sets the
L<cursor_class|DBIO::Storage::DBI/cursor_class> to
L<DBIO::Storage::DBI::ADO::MS_Jet::Cursor> to normalize returned
C<GUID> values and provides L<DBIO::InflateColumn::DateTime> support
...
L<problems|DBIO::Storage::DBI::ODBC::ACCESS/"TEXT/IMAGE/MEMO COLUMNS">
the L<ODBC|DBIO::Storage::DBI::ODBC::ACCESS> driver has with these types
...
L<ODBC|DBIO::Storage::DBI::ODBC::ACCESS> driver it is converted to
C<VARCHAR(255)>.
...
your L<connect_info|DBIO::Storage::DBI/connect_info>, it will be
multiplied by two and C<1> added, just as for the
L<ODBC|DBIO::Storage::DBI::ODBC::ACCESS> driver.
...
sub select_single {
  ...
  return @row unless
    $self->cursor_class->isa('DBIO::Storage::DBI::ADO::MS_Jet::Cursor');
...
sub datetime_parser_type {
  'DBIO::Storage::DBI::ADO::MS_Jet::DateTime::Format'
}
