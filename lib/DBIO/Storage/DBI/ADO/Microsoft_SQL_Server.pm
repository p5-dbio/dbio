package DBIO::Storage::DBI::ADO::Microsoft_SQL_Server;
...
__PACKAGE__->cursor_class(
  'DBIO::Storage::DBI::ADO::Microsoft_SQL_Server::Cursor'
);

__PACKAGE__->datetime_parser_type (
  'DBIO::Storage::DBI::ADO::Microsoft_SQL_Server::DateTime::Format'
);
...
DBIO::Storage::DBI::ADO::Microsoft_SQL_Server - Support for Microsoft
...
with L<DBD::ADO>. See L<DBIO::Storage::DBI::MSSQL/IMPLEMENTATION NOTES>
...
(L<DBIO::Storage::DBI::ADO::Microsoft_SQL_Server::Cursor>) removes them,
...
(L<DBIO::Storage::DBI::ADO::Microsoft_SQL_Server::Cursor>) so that you
...
Fractional seconds with L<DBIO::InflateColumn::DateTime> are not
