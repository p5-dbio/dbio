...
# cheat
require DBIC::Storage::DBI::mysql;
*DBIC::Storage::DBI::mysql::_get_server_version = sub { 5 };
bless ( $schema->storage, 'DBIC::Storage::DBI::mysql' );
...
for (
  ...
  # to clear the server version cache and then get a new maker
  {
    ...
    local *DBIC::Storage::DBI::mysql::_get_server_version = sub { $ver };
