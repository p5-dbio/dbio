...
isa_ok($art, 'DBIO::ResultSet', 'get a DBIO::ResultSet object');
my $next = $art->next;
...
warnings_exist {
  $artist_rs->find({})
} qr/\QDBIO::ResultSet::find(): Query returned more than one row/, "Non-unique find generated a cursor inexhaustion warning";
