...
plan skip_all => 'Test needs ' . DBIO::Optional::Dependencies->req_missing_for ('test_rdbms_informix')
  unless DBIO::Optional::Dependencies->req_ok_for ('test_rdbms_informix');
