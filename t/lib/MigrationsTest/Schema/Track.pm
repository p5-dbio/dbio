...
__PACKAGE__->load_components(qw{
    +MigrationsTest::DeployComponent
...
__PACKAGE__->belongs_to( cd => 'MigrationsTest::Schema::CD', undef, {
    proxy => { cd_title => 'title' },
});
# custom condition coderef
__PACKAGE__->belongs_to( cd_cref_cond => 'MigrationsTest::Schema::CD',
sub {
...
__PACKAGE__->belongs_to( disc => 'MigrationsTest::Schema::CD' => 'cd', {
    proxy => 'year'
});

__PACKAGE__->might_have( cd_single => 'MigrationsTest::Schema::CD', 'single_track' );
__PACKAGE__->might_have( lyrics => 'MigrationsTest::Schema::Lyrics', 'track_id' );

__PACKAGE__->belongs_to(
    "year1999cd",
    "MigrationsTest::Schema::Year1999CDs",
    'cd',
    { join_type => 'left' },  # the relationship is of course optional
);
__PACKAGE__->belongs_to(
    "year2000cd",
    "MigrationsTest::Schema::Year2000CDs",
    'cd',
    { join_type => 'left' },
);
