...
DBICTest - Library to be used by DBIO test scripts
...
=head2 init_schema
  ...
  my $schema = DBICTest->init_schema(
    ...
    storage_type_args=>{
      balancer_type=>'DBIO::Storage::DBI::Replicated::Balancer::Random'
    },
  );
