...
# We need a separate schema class to avoid leaking into DBICTest's leak tracker
{
  ...
  __PACKAGE__->register_class('Artist' => 'DBICTest::Schema::Artist');
  __PACKAGE__->register_class('CD' => 'DBICTest::Schema::CD');
  __PACKAGE__->register_class('Genre' => 'DBICTest::Schema::Genre');
}
