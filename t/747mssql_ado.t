...
plan skip_all => 'Test needs ' . DBIO::Optional::Dependencies->req_missing_for ('test_rdbms_mssql_ado')
  unless DBIO::Optional::Dependencies->req_ok_for ('test_rdbms_mssql_ado');
...
isa_ok($schema->storage, 'DBIO::Storage::DBI::ADO::Microsoft_SQL_Server');
